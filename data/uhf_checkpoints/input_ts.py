"""Converge the UHF reference state of the TS (side-on doublet).
...
GEOMETRY = "../geometries/TS_side_on_doublet.xyz"
...
mf.conv_tol = 1e-8
mf.max_cycle = 200
mf.chkfile = "ts_uhf.chk"          # output; the published file is not overwritten
